...
namespace EventPlannerWebApplication.Data
{
    ...
    {
        public EventPlannerWebApplicationContext (DbContextOptions<EventPlannerWebApplicationContext> options)
            : base(options)
        {
        }
        ...
        public DbSet<EventPlannerWebApplication.Models.Services.Food> Food { get; set; }
    }
}
